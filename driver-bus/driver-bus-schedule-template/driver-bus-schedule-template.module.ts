...
import { DriverBusScheduleTemplateController } from './driver-bus-schedule-template.controller';
...
@Module({
  ...
  controllers: [DriverBusScheduleTemplateController],
  providers: [DriverBusScheduleTemplateService],
  exports: [DriverBusScheduleTemplateService],
})
export class DriverBusScheduleTemplateModule {}
