...
@Injectable()
export class DriverBusScheduleLayoutService {
  constructor(
  ...
  async findAll(tenantId: Types.ObjectId): Promise<DriverBusScheduleLayoutDto[]> {
  ...
  async findOne(busScheduleId: Types.ObjectId, tenantId: Types.ObjectId): Promise<DriverBusScheduleLayoutDto> {
  ...
  ): Promise<DriverBusScheduleLayoutDto> {
